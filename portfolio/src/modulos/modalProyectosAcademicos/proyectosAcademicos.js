...
export function getProyectosAcademicos() {
  ...
  const ScreenShots = [
    {img: "./assets/projects/comiquea.webp", title: "Comiquea. Web de cómics", text: "Frontend con HTML, CSS, React y JavaScript. Backend con Node.js, Express y MongoDB Atlas. La web es un organizador de lectura de cómics, con registro y login de usuarios que podrán dejar opiniones de cada cómic, crear listas de sus cómics favoritos, los que tienen, los leídos, los que quieren comprar... Además, también sirve como enciclopedia de cómics, ya que utiliza una base de datos cuya información crece de forma orgánica gracias a los aportes de los propios usuarios, quienes pueden añadir nuevos cómics y modificar los datos de los ya existentes.", alt: "Previsualizacion del proyecto Comiquea, la web de cómics.", link: "https://comiquea.vercel.app/"},

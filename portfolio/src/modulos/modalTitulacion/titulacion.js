...
export function getTitulacion() {
  ...
  const ScreenShots = [
    ...
    {img: "https://acrobat.adobe.com/id/urn:aaid:sc:EU:72e648b1-6f4d-4bc0-a519-fe5806c45561", title: "C1B3RWALL ACADEMY", text: "Diploma por superar el curso C1B3ERWALL ACADEMY sobre ciberseguridad en sistemas basados en blockchain, impartido por la Universidad de Salamanca, el grupo de investigación BISITE y la colaboración de la Policia Nacional", alt: "Previsualización del título de CIBERWALL ACADEMY.", link: "https://acrobat.adobe.com/id/urn:aaid:sc:EU:72e648b1-6f4d-4bc0-a519-fe5806c45561"}
  ]

...
export function getSobreMi() {
  ...
  const paragraphs = [
    ...
    "Llegó el momento de tomar un nuevo rumbo. Ya había escrito algunos blogs por pura afición y uno de ellos estaba creciendo bastante en número de lectores. Se me ocurrian muchas ideas que añadir a dicho blog, pero no tenia los conocimientos para hacerlo, así que... ¿Por qué no estudiar y aprender sobre ello?",
    ...
    'Actualmente estoy estudiando un master en "Desarrollo web full stack" con la escuela The Power y no paro de poner en práctica diferentes proyectos web que se me van ocurriendo para lanzarme al mercado laboral',
